...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26567 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26567(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26577 = (function (port,val,fn1_handler){
var x__4550__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26577(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26588 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26588(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26594 = (function (chan){
var x__4550__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26594(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26598 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26598(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26609 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26609(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26613 = (function (h){
var x__4550__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26613(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26618 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26618(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26622 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26622(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26625 = (function (b,itm){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26625(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26637 = (function (b){
var x__4550__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26637(b);
}
});
