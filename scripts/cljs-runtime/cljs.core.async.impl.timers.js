...
var i_29673 = (0);
while(true){
if((i_29673 < arr.length)){
(arr[i_29673] = null);

var G__29675 = (i_29673 + (1));
i_29673 = G__29675;
continue;
} else {
}
...
var i_29690 = (self__.level + (1));
while(true){
if((i_29690 <= (new_level + (1)))){
(update[i_29690] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_29694 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29694[i]));
} else {
x__$2.forward.push((((i < links_29694.length))?(links_29694[i]):null));
}

if((i < links_29694.length)){
(links_29694[i] = x__$2);
} else {
links_29694.push(x__$2);
}
...
var i_29698 = (0);
while(true){
if((i_29698 <= self__.level)){
var links_29699 = (update[i_29698]).forward;
if((x__$1 === (((i_29698 < links_29699.length))?(links_29699[i_29698]):null))){
(links_29699[i_29698] = (x__$1.forward[i_29698]));

var G__29700 = (i_29698 + (1));
i_29698 = G__29700;
continue;
} else {
...
var G__29708 = nx;
var G__29709 = (level__$1 - (1));
x = G__29708;
level__$1 = G__29709;
continue;
} else {
var G__29712 = x;
var G__29713 = (level__$1 - (1));
x = G__29712;
level__$1 = G__29713;
continue;
}
